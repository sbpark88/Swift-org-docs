...
let opaqueFlippedTriangleA = flip(smallTriangle)
let opaqueFlippedTriangleB = flip(smallTriangle)

print(smallTriangle.draw())
print("")
print(flip(smallTriangle).draw())
print("")
//print(flip(flip(smallTriangle)).draw())

let flipTwice = flip(flip(smallTriangle))
print(flipTwice.draw())


print(smallTriangle.draw())
print("")
print(protocolFlip(smallTriangle).draw())
print("")
//print(protocolFlip(protocolFlip(smallTriangle)).draw())

let protoFlipTwice = protocolFlip(protocolFlip(smallTriangle))
print(protoFlipTwice.draw())
